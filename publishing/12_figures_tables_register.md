...
| 图38-1 | 图 | 图38-1：Figure 38-1 | Ch38 | 第38章：视觉文档与结构化表格数据工程 | 本书资源：`docs/images/part12/ch38_01_schema_decomposition.png` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图38-1：Figure 38-1 | 是 |
| 图38-2 | 图 | 图38-2：Figure 38-2 | Ch38 | 第38章：视觉文档与结构化表格数据工程 | 本书资源：`docs/images/part12/ch38_02_dataset_construction_pipeline.png` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图38-2：Figure 38-2 | 是 |
| 图38-3 | 图 | 图38-3：Figure 38-3 | Ch38 | 第38章：视觉文档与结构化表格数据工程 | 本书资源：`docs/images/part12/ch38_03_structural_consistency_validation.png` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图38-3：Figure 38-3 | 是 |
| 图38-4 | 图 | 图38-4：表格样本三类监督信号结构图 | Ch38 | 第38章：视觉文档与结构化表格数据工程 | 本书资源：`docs/images/part12/ch38_04_supervision_schema.png` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图38-4：表格样本三类监督信号结构图 | 是 |
| 图38-5 | 图 | 图38-5：SparseTable-Bench 四阶段构建流水线图 | Ch38 | 第38章：视觉文档与结构化表格数据工程 | 本书资源：`docs/images/part12/ch38_05_stb_pipeline.png` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图38-5：SparseTable-Bench 四阶段构建流水线图 | 是 |
| 图38-6 | 图 | 图38-6：STB-Mask-Stress 遮挡生成与评测流程图 | Ch38 | 第38章：视觉文档与结构化表格数据工程 | 本书资源：`docs/images/part12/ch38_06_mask_stress_flow.png` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图38-6：STB-Mask-Stress 遮挡生成与评测流程图 | 是 |
| 图39-1 | 图 | 图39-1：多图表信息图推理数据集领域覆盖分布 | Ch39 | 第39章：视觉推理与工具调用数据工程 | 本书资源：`docs/images/part12/ch39_01_domain_distribution.png` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图39-1：多图表信息图推理数据集领域覆盖分布 | 是 |
| 图39-2 | 图 | 图39-2：多图表信息图推理数据集子图表类型分布 | Ch39 | 第39章：视觉推理与工具调用数据工程 | 本书资源：`docs/images/part12/ch39_02_chart_type_distribution.png` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图39-2：多图表信息图推理数据集子图表类型分布 | 是 |
| 图39-3 | 图 | 图39-3：多图表信息图推理数据集子问题类型分布 | Ch39 | 第39章：视觉推理与工具调用数据工程 | 本书资源：`docs/images/part12/ch39_03_question_type_distribution.png` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图39-3：多图表信息图推理数据集子问题类型分布 | 是 |
| 图39-4 | 图 | 图39-4：多图表信息图样本（鲨鱼袭击） | Ch39 | 第39章：视觉推理与工具调用数据工程 | 本书资源：`docs/images/part12/ch39_04_shark_attack_infographic.jpg` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图39-4：多图表信息图样本（鲨鱼袭击） | 是 |
| 图39-5 | 图 | 图39-5：多图标信息图推理数据集四阶段构建流水线图 | Ch39 | 第39章：视觉推理与工具调用数据工程 | 本书资源：`docs/images/part12/ch39_05_multichart_dataset_pipeline.png` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图39-5：多图标信息图推理数据集四阶段构建流水线图 | 是 |
| 图39-6 | 图 | 图39-6：MedImage-ToolVQA 数据构建概念流程 | Ch39 | 第39章：视觉推理与工具调用数据工程 | 本书资源：`docs/images/part12/ch39_06_medimage_tool_vqa_pipeline.svg` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图39-6：MedImage-ToolVQA 数据构建概念流程 | 是 |
| 图39-7 | 图 | 图39-7：工具调用多轮轨迹结构 | Ch39 | 第39章：视觉推理与工具调用数据工程 | 本书资源：`docs/images/part12/ch39_07_tool_trajectory_structure.svg` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图39-7：工具调用多轮轨迹结构 | 是 |
| 图39-8 | 图 | 图39-8：SFT schema 中的真实图像与 bbox 证据 | Ch39 | 第39章：视觉推理与工具调用数据工程 | 本书资源：`docs/images/part12/ch39_08_sft_bbox_evidence.svg` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图39-8：SFT schema 中的真实图像与 bbox 证据 | 是 |
| 图39-9 | 图 | 图39-9：质量控制与人工复核门禁 | Ch39 | 第39章：视觉推理与工具调用数据工程 | 本书资源：`docs/images/part12/ch39_09_quality_review_gate.svg` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图39-9：质量控制与人工复核门禁 | 是 |
| 图40-1 | 图 | 图40-1：语义响应与风格控制双通道 schema | Ch40 | 第40章：交互控制与推理轨迹数据工程 | 本书资源：`docs/images/part12/ch40_01_dual_channel_schema.svg` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图40-1：语义响应与风格控制双通道 schema | 是 |
| 图40-2 | 图 | 图40-2：VoiceStyleControl 数据构建流水线 | Ch40 | 第40章：交互控制与推理轨迹数据工程 | 本书资源：`docs/images/part12/ch40_02_voice_style_data_pipeline.svg` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图40-2：VoiceStyleControl 数据构建流水线 | 是 |
| 图40-3 | 图 | 图40-3：质量评估与数据飞轮闭环 | Ch40 | 第40章：交互控制与推理轨迹数据工程 | 本书资源：`docs/images/part12/ch40_03_quality_loop.svg` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图40-3：质量评估与数据飞轮闭环 | 是 |
| 图40-4 | 图 | 图40-4：Latent-Switch-69K 构建流水线图 | Ch40 | 第40章：交互控制与推理轨迹数据工程 | 本书资源：`docs/images/part12/ch40_04_latent_switch_pipeline.svg` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图40-4：Latent-Switch-69K 构建流水线图 | 是 |
| 图40-5 | 图 | 图40-5：Latent-Switch-69K 数据来源与领域组成 | Ch40 | 第40章：交互控制与推理轨迹数据工程 | 本书资源：`docs/images/part12/ch40_05_dataset_composition.png` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图40-5：Latent-Switch-69K 数据来源与领域组成 | 是 |
| 图40-6 | 图 | 图40-6：原始 CoT、压缩 CoT 与 latent placeholder 对比 | Ch40 | 第40章：交互控制与推理轨迹数据工程 | 本书资源：`docs/images/part12/ch40_06_cot_latent_comparison.svg` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图40-6：原始 CoT、压缩 CoT 与 latent placeholder 对比 | 是 |
| 图40-7 | 图 | 图40-7：原始与蒸馏后推理长度及压缩率统计 | Ch40 | 第40章：交互控制与推理轨迹数据工程 | 本书资源：`docs/images/part12/ch40_07_token_compression_distribution.png` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图40-7：原始与蒸馏后推理长度及压缩率统计 | 是 |
| 图40-8 | 图 | 图40-8：Supervision mask 示意图 | Ch40 | 第40章：交互控制与推理轨迹数据工程 | 本书资源：`docs/images/part12/ch40_08_supervision_mask.svg` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图40-8：Supervision mask 示意图 | 是 |
| 图41-1 | 图 | 图41-1 FineWeb MinHash 去重和 PII 处理流程 | Ch41 | 第41章：FineWeb 预训练语料数据工程 | 本书资源：`docs/images/part12/ch41_01_fineweb_minhash_pii_flow.svg` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图41-1 FineWeb MinHash 去重和 PII 处理流程 | 是 |
| 图41-2 | 图 | 图41-2 FineWeb 数据处理选择的消融评估回路 | Ch41 | 第41章：FineWeb 预训练语料数据工程 | 本书资源：`docs/images/part12/ch41_02_fineweb_ablation_loop.svg` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图41-2 FineWeb 数据处理选择的消融评估回路 | 是 |
| 图42-1 | 图 | 图42-1 Dolma 透明语料证据链 | Ch42 | 第42章：Dolma 预训练语料透明账本 | 本书资源：`docs/images/part12/ch42_01_dolma_evidence_chain.svg` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图42-1 Dolma 透明语料证据链 | 是 |
| 图42-2 | 图 | 图42-2 Dolma source mix 与训练诊断回路 | Ch42 | 第42章：Dolma 预训练语料透明账本 | 本书资源：`docs/images/part12/ch42_02_dolma_source_mix_diagnosis.svg` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图42-2 Dolma source mix 与训练诊断回路 | 是 |
| 图43-1 | 图 | 图43-1 LAION-5B 图文候选记录的多通道 schema | Ch43 | 第43章：LAION-5B 图文候选池与筛选通道 | 本书资源：`docs/images/part12/ch43_01_laion_multichannel_schema.svg` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图43-1 LAION-5B 图文候选记录的多通道 schema | 是 |
| 图43-2 | 图 | 图43-2 图文候选池质量评估与闭环修复 | Ch43 | 第43章：LAION-5B 图文候选池与筛选通道 | 本书资源：`docs/images/part12/ch43_02_laion_quality_datacomp_loop.svg` | 内部自绘/改绘资源；终稿复核高清源与 AI 使用声明 | 图43-2 图文候选池质量评估与闭环修复 | 是 |
