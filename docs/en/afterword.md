...
If you are working on pre-training, instruction fine-tuning, or preference alignment, it is better to start with Parts 2, 4, and 5, then combine them with the open-source recipes in Part XIII and the project walkthroughs in Part XIV to understand the commonalities and differences across different tasks.
