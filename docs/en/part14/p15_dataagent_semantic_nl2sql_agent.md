# Project 15: DataAgent Semantic Business Intelligence Assistant

<div class="chapter-authors">Xuhong Cao; Zhongyi Liu; Jun Yu</div>

## Abstract

This project uses DataAgent to build a semantic business intelligence (BI) assistant for enterprise structured data. The goal is not to let a model directly "guess SQL." Instead, the project organizes natural-language questions, the business semantic layer, database metadata, a natural-language-to-SQL (NL2SQL) sub-agent, result files, report generation, and runtime audit trails into a reusable data engineering chain.

Read in engineering order, the project follows a complete chain from business question to trustworthy delivery.
...
DataAgent; semantic layer; natural-language-to-SQL (NL2SQL); enterprise business intelligence (BI); agent orchestration
...
Figure P15-1 summarizes the engineering chain from business question to trustworthy delivery.
...
Listing P15-1 provides a semantic BI workflow example.
...
Listing P15-2 provides a project case title example.
...
Listing P15-3 provides a Python implementation excerpt.
...
Listing P15-4 provides a command-line run example.
...
Listing P15-8 provides a command-line run example.
...
Listing P15-10 provides a directory or artifact path example.
...
Listing P15-11 gives a command-line example for the minimal local run path.
...
Listing P15-12 provides a YAML configuration example.
...
Listing P15-13 provides a directory or artifact path example.
...
Listing P15-15 provides a agent role flow example.
...
Listing P15-16 provides a business question example.
...
Listing P15-17 provides a pre-flight checklist example.
...
Listing P15-20 provides a command-line run example.
...
Listing P15-21 provides a directory or artifact path example.
...
Listing P15-22 provides a directory or artifact path example.
...
Listing P15-23 provides a command-line run example.
...
Listing P15-24 provides a tool-use instruction example.
...
Listing P15-25 provides a semantic BI delivery pipeline example.
...
Listing P15-26 provides a semantic BI reasoning chain example.
