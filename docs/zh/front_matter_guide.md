...
![图 0-1：《大模型数据工程》全书架构图，展示数据全生命周期、基础层、数据采集与处理层、横切能力、模型对齐与能力增强层、应用治理层、安全合规与专项实践层、项目实战层、DataOps 飞轮和平台支撑能力之间的关系](../images/Yu-FrontMatter-Fig01-ZH.png)

*图 0-1：全书架构图。来源：本书自绘。该图以数据全生命周期为主线，将十四篇、四十八章、十五个项目和八个附录组织为基础、采集处理、横切能力、模型对齐、应用治理、安全合规、专项实践和项目交付等层级。*
