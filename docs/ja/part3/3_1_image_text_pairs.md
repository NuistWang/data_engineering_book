...
![図 6-1: 画像前処理におけるトリミングとセマンティック調整](../../images/part3/Wang-Chap06-Fig01-ZH.png)
...
![図 6-2: DALI を使用した場合と使用しない場合のデータのデコードと変換](../../images/part3/Wang-Chap06-Fig02-ZH.png)
...
![図 6-3: Ray Data 分散型洗浄データの流れ](../../images/part3/Wang-Chap06-Fig03-ZH.png)
