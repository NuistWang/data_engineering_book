...
![図 8-1: 2 つのビデオ シーン セグメンテーション戦略と HSV ヒストグラムの違い](../../images/part3/Yu-Chap08-Fig01-ZH.png)
...
![図 8-2: 通常の ASR (セグメント レベル) と WhisperX (単語/音素レベル) の精度の比較](../../images/part3/Yu-Chap08-Fig02-ZH.png)
